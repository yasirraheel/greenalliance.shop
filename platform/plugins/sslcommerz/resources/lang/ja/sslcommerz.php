...
return [
    ...
    'checkout_successfully' => 'チェックアウトが成功しました！',
    'invalid_data' => '無効なデータ！',
    'invalid_transaction' => '無効な取引！',
    'transaction_completed' => '取引が正常に完了しました！',
    'validation_fail' => '検証に失敗しました！',
    'transaction_already_completed' => '取引は既に正常に完了しています！',
];
