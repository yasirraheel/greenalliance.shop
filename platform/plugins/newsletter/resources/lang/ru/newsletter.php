...
return [
    ...
    'popup_image' => 'Изображение для десктопа',
    'popup_image_helper' => 'Для устройств с шириной от 1200px.',
    'popup_tablet_image' => 'Изображение для планшета',
    'popup_tablet_image_helper' => 'Для устройств с шириной от 768px до 1199px. Если пусто, будет использовано изображение для десктопа.',
    'popup_mobile_image' => 'Изображение для мобильного',
    'popup_mobile_image_helper' => 'Для устройств с шириной менее 768px. Если пусто, будет использовано изображение для планшета.',
