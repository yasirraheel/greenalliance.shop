...
class CategoryTable extends TableAbstract
{
    public function setup(): void
    {
        $this
            ...
            ->addActions([
                EditAction::make()->route('property_category.edit'),
                DeleteAction::make()->route('property_category.destroy'),
            ]);
    }
        ...
        return [
            ...
            FormattedColumn::make('name')
                ...
                ->renderUsing(function (FormattedColumn $column) {
                    ...
                    return $indent . $icon . '<a href="' . route('property_category.edit', $category->id) . '">' . $category->name . '</a>';
                }),
            FormattedColumn::make('parent_id')
                ->title(trans('plugins/real-estate::category.parent'))
                ->alignStart()
                ->renderUsing(function (FormattedColumn $column) {
    ...
    {
        return [
            DeleteBulkAction::make()->permission('property_category.destroy'),
        ];
    }
        ...
        return [
            ...
            'parent_id' => [
                ...
                'callback' => function (int|string|null $value = null): array {
                    ...
                    return [
                        'url' => route('property_category.search'),
    ...
    {
        if ($this->isEmpty()) {
            return view('plugins/real-estate::categories.intro');
        }
