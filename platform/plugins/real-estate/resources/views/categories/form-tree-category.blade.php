        ...
        <div class="col-12">
            <x-core::alert type="info" class="bg-white text-info">
                <div class="d-flex align-items-center">
                    <div>
                        {{ trans('plugins/real-estate::category.table_view_info', ['default' => 'For easier bulk management of categories, you can also']) }}
                        <a href="{{ route('property_category.index', ['as' => 'table']) }}" class="text-decoration-underline">
                            {{ trans('plugins/real-estate::category.manage_as_table', ['default' => 'manage categories as a table']) }}
                        </a>
                    </div>
                </div>
            </x-core::alert>
