...
<p>{{ 'plugins/real-estate::real-estate.email_templates.payment_received_message' | trans({'name': account_name}) }}</p>
<p>{{ 'plugins/real-estate::real-estate.email_templates.field_account' | trans }} {{ account_name }} ({{ account_email }})</p>
