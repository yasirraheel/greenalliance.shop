...
return [
    ...
    'cache_size_warning_dynamic' => 'Το μέγεθος της cache του CMS σας είναι αρκετά μεγάλο (>:sizeMB). Η εκκαθάρισή της μπορεί να βελτιώσει την απόδοση του συστήματος.',
