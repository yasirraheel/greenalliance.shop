...
return [
    ...
    'templates' => [
        ...
        'test' => [
            'title' => 'core/setting::setting.email.template_test',
            'description' => 'core/setting::setting.email.template_test_description',
            'subject' => 'core/setting::setting.email.template_test_subject',
            'can_off' => false,
        ],
    ],
];
